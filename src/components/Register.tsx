...
function Register() {
  ...
  return (
    <div className="w-full flex justify-center items-center">
      <article
        className="w-full sm:w-4/5 md:w-3/5 lg:w-2/5 bg-secondary-200 sm:rounded-xl sm:my-5 px-10 py-4 flex flex-col items-center">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <section className="w-full flex justify-center">
            <button className="bg-gray-500 px-10 mt-1 py-1 rounded-full text-white font-bold">Submit</button>
          </section>
        </form>
      </article>
    </div>
